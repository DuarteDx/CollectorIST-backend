...
export default async (token, assetId, newObjectHistory) => {
  return jwt.verify(token, 'secretKey', async (err, authData) => {
    if (err) {
      ...
      console.log(time + ' POST -> Edit asset Object History with id ' + assetId)
      ...
      await db.collection('assets').updateOne(
        ...
        {
          $set: { 'ObjectHistory': newObjectHistory },
      ...
      return 'Edited asset Object History with _id: ' + assetId
    }
  })
}
